...
export default function MarketingNavbar() {
    ...
    const sections = {
        ...
        Solutions: [
            { title: 'Government & Public Sector', desc: 'Digitize your entire ministry workflow.', icon: Landmark, href: '/solutions/government' },
            ...
            { title: 'Healthcare', desc: 'Secure patient records and inter-hospital communication.', icon: Stethoscope, href: '/solutions/healthcare' },
            { title: 'Education', desc: 'Digital certificates and academic record verification.', icon: GraduationCap, href: '/solutions/education' },
            { title: 'Legal', desc: 'Tamper-proof court documents and case files.', icon: Scale, href: '/solutions/legal' },
            { title: 'Financial Services', desc: 'Secure transaction records and audit trails.', icon: Briefcase, href: '/solutions/financial-services' },
        ],
        Resources: [
